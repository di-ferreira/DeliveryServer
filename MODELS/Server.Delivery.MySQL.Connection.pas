...
type
  TServerDeliveryMySQLConnection = class(TInterfacedObject, iModelServerDeliveryConnection)
  private
...
begin
  ...
  FConnection.ExecSQL('CREATE TABLE IF NOT EXISTS PRODUTOS (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome STRING NOT NULL, preco DECIMAL (10, 2) NOT NULL, estoque INTEGER NOT NULL DEFAULT (0));');
end;
...
class function TServerDeliveryMySQLConnection.New: iModelServerDeliveryConnection;
begin
  Result := Self.Create;
end;
