...
begin
  ...
  FConnection.ExecSQL('CREATE TABLE IF NOT EXISTS CAIXAS (ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, DATA DATE DEFAULT (CURRENT_TIMESTAMP) NOT NULL, ABERTO BOOLEAN NOT NULL DEFAULT (false),TOTAL  DECIMAL (10, 2) DEFAULT (0.00));');
