...
type
  ...
  public
    ...
    function ListAll: TObjectList<TPEDIDO>;
    function ListOne(aID: Integer): TPEDIDO;
  end;
...
function TModelServerDeliveryPedido.ListAll: TObjectList<TPEDIDO>;
begin

end;

function TModelServerDeliveryPedido.ListOne(aID: Integer): TPEDIDO;
begin
